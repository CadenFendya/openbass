import { Bot, Fish, Home, Map, Settings, Waves, NotebookTabs } from 'lucide-react';

const items = [
  ['home', Home, 'Home'], ['conditions', Waves, 'Conditions'], ['baits', Fish, 'Baits'],
  ['maps', Map, 'Maps'], ['logbook', NotebookTabs, 'Log'], ['ai', Bot, 'AI'], ['settings', Settings, 'Settings']
] as const;
